...
Possible causes and solutions:
  ...
  2. You didn't set the shield and HP range properly.
  3. Your ship HP or shield level is too low to use kami, for example, because your ship is not able to fill it up, since it's too slow and is constantly attacked by the aliens. Also. make sure you didn't set the Moth or Wheel as formation used to throw pet kamikaze, since they are constantly decreasing your shields level.
